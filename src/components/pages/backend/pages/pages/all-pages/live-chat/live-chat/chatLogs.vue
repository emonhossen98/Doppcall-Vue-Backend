                      ...
                      <ul class="px-0 mt-3" id="offer-extra-filter">
                        ...
                        <li class="position-relative">
                          ...
                          <template v-if="applyfillters.includes('Phone')">
                            <span @click="removeSearch('Phone', 'phone_no', 'search')" id="remove-to-search-list">x</span>
                          </template>
                        </li>
                        <li class="position-relative">
                        ...
                        <li class="position-relative">
                          ...
                          <template v-if="applyfillters.includes('Message')">
                            <span @click="removeSearch('Message', 'message', 'search')" id="remove-to-search-list">x</span>
                          </template>
                        </li>
                    ...
                    <div class="col-md-6 ps-4">
                      <div v-if="checkfilter.showcolumn != null && checkfilter.showcolumn != ''">
                        ...
                        <template v-if="checkfilter.showcolumn == 'Role' && checkfilter.types.includes('select')">
                          <div class="form-check mb-2">
                            <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                              v-model="checkfilter.emptyValues['role_id']" type="checkbox" value="1" id="isemptyvalue">
                            <label class="form-check-label" for="isemptyvalue">
                              is Empty
                            </label>
                          </div>
                        ...
                        <template v-if="checkfilter.showcolumn == 'First Name' && checkfilter.types.includes('search')">
                          <div class="form-check mb-2">
                            <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                              v-model="checkfilter.emptyValues['fname']" type="checkbox" value="1" id="isemptyvalue">
                            <label class="form-check-label" for="isemptyvalue">
                              is Empty
                            </label>
                          </div>
                        ...
                        <template v-if="checkfilter.showcolumn == 'Last Name' && checkfilter.types.includes('search')">
                          <div class="form-check mb-2">
                            <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                              v-model="checkfilter.emptyValues['lname']" type="checkbox" value="1" id="isemptyvalue">
                            <label class="form-check-label" for="isemptyvalue">
                              is Empty
                            </label>
                          </div>
                        ...
                        <template v-if="checkfilter.showcolumn == 'Phone' && checkfilter.types.includes('search')">
                          <div class="form-check mb-2">
                            <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                              v-model="checkfilter.emptyValues['phone_no']" type="checkbox" value="1" id="isemptyvalue">
                            <label class="form-check-label" for="isemptyvalue">
                              is Empty
                            </label>
                          </div>
                        ...
                        <template v-if="checkfilter.showcolumn == 'Browser' && checkfilter.types.includes('search')">
                          <div class="form-check mb-2">
                            <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                              v-model="checkfilter.emptyValues['browser']" type="checkbox" value="1" id="isemptyvalue">
                            <label class="form-check-label" for="isemptyvalue">
                              is Empty
                            </label>
                          </div>
                        ...
                        <template v-if="checkfilter.showcolumn == 'OS' && checkfilter.types.includes('search')">
                          <div class="form-check mb-2">
                            <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                              v-model="checkfilter.emptyValues['os']" type="checkbox" value="1" id="isemptyvalue">
                            <label class="form-check-label" for="isemptyvalue">
                              is Empty
                            </label>
                          </div>
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <template v-if="checkfilter.showcolumn == 'First Name' && checkfilter.types.includes('search')">
                              <label for="filtertext">Contains</label>
                              <input type="text" @keyup="clickCheckboxFilters(checkfilter.showcolumn)"
                                v-model="checkfilter.searchValues['fname']" class="form-control mb-2" id="filtertext"
                                placeholder="Search here..">
                            </template>
                            <template v-if="checkfilter.showcolumn == 'Last Name' && checkfilter.types.includes('search')">
                              <label for="filtertext">Contains</label>
                              <input type="text" @keyup="clickCheckboxFilters(checkfilter.showcolumn)"
                                v-model="checkfilter.searchValues['lname']" class="form-control mb-2" id="filtertext"
                                placeholder="Search here..">
                            </template>
                            <template v-if="checkfilter.showcolumn == 'Email' && checkfilter.types.includes('search')">
                              <label for="filtertext">Contains</label>
                            ...
                            <template v-if="checkfilter.showcolumn == 'Phone' && checkfilter.types.includes('search')">
                              <label for="filtertext">Contains</label>
                              <input type="text" @keyup="clickCheckboxFilters(checkfilter.showcolumn)"
                                v-model="checkfilter.searchValues['phone_no']" class="form-control mb-2" id="filtertext"
                                placeholder="Search here..">
                            </template>
                            <template v-if="checkfilter.showcolumn == 'Browser' && checkfilter.types.includes('search')">
                              <label for="filtertext">Contains</label>
                              <input type="text" @keyup="clickCheckboxFilters(checkfilter.showcolumn)"
                                v-model="checkfilter.searchValues['browser']" class="form-control mb-2" id="filtertext"
                                placeholder="Search here..">
                            </template>
                            <template v-if="checkfilter.showcolumn == 'OS' && checkfilter.types.includes('search')">
                              <label for="filtertext">Contains</label>
                              <input type="text" @keyup="clickCheckboxFilters(checkfilter.showcolumn)"
                                v-model="checkfilter.searchValues['os']" class="form-control mb-2" id="filtertext"
                                placeholder="Search here..">
                            </template>
                            <template v-if="checkfilter.showcolumn == 'Message' && checkfilter.types.includes('search')">
                              <label for="filtertext">Contains</label>
...
export default {
  ...
  methods: {
          ...
          var table = $("#chat_logs_tables").DataTable({
            ...
            columns: [
              ...
              render: function (data, type, full, meta) {
                   if(full?.sender?.name != null){
                      return '<span title="'+full?.sender?.name+'">'+full?.sender?.name+'</span>';
                   }else{
                    return '----';
                   }
                    }
              ...
              { data: "sender.role",
              render: function (data, type, full, meta) {
                   if(full?.sender?.role.secondary_name != null){
                      return '<span class="badge bg-success text-white" title="'+full?.sender?.role.secondary_name+'">'+full?.sender?.role.secondary_name+'</span>';
                   }else{
                    return '----';
                   }
                    }
              ...
              { data: "sender.lname",
              render: function (data, type, full, meta) {
                   if(full?.sender?.lname != null){
                      return '<span title="'+full?.sender?.lname+'">'+full?.sender?.lname+'</span>';
                   }else{
                    return '----';
                   }
                    }
              ...
              { data: "sender.phone_no",
                render: function (data, type, full, meta) {
                   if(full?.sender?.phone_no != null){
                      return '<span title="'+full?.sender?.phone_no+'">'+full?.sender?.phone_no+'</span>';
                   }else{
                    return '----';
                   }
                    }
              ...
              { data: "sender.browser",
                render: function (data, type, full, meta) {
                   if(full?.sender?.browser != null){
                      return '<span title="'+full?.sender?.browser+'">'+full?.sender?.browser+'</span>';
                   }else{
                    return '----';
                   }
                    }
              ...
              { data: "sender.os",
                render: function (data, type, full, meta) {
                   if(full?.sender?.os != null){
                      return '<span title="'+full?.sender?.os+'">'+full?.sender?.os+'</span>';
                   }else{
                    return '----';
                   }
                    }
    ...
    getFiltarOfExtranalFilter(perPage = 10,) {
          axios
            .post(
              this.globalVariables.apiUrl + "admin/chat/message/deleted/data/search-get-data-all-filter",
              this.checkfilter,
              {
                headers: { Authorization: "Bearer " + localStorage.getItem("token") }
              }
            ...
            .then((res) => {
              ...
              if ($.fn.DataTable.isDataTable("#chat_logs_tables")) {
                const table = $("#chat_logs_tables").DataTable();
                table.clear();
                table.rows.add(res.data.messages ?? []);
                table.draw();
              } else {
                const formatTimestamp = this.formatTimestamp; 
                var table = $("#chat_logs_tables").DataTable({
