                  ...
                  <div class="col-12">
                    ...
                    <li>
                      <button
                        ...
                        >
                          <i class="fa-solid fa-key w-40 me-1"></i> Change Password
                        </button>
                    </li>
                    <li>
                      <button
  ...
  export default {
    ...
    methods: {
      getAdvertisherAccountData() {
        this.getLoader = true;
        axios
          .get(this.globalVariables.apiUrl+"account-manager/profile", {
      ...
      AdvertisherAccountDataUpdate() {
        this.getLoader = true;
        axios
          .post(this.globalVariables.apiUrl+"account-manager/profile/update", this.userUpdate, {
            headers: {
      ...
      AdvertisherPasswordUpdate() {
        ...
        axios
          .post(
            this.globalVariables.apiUrl+"account-manager/password/update",
            this.passwordUpdate,
            {
              headers: { Authorization: "Bearer " + localStorage.getItem("token") },
            }
