...
export default {
  ...
  methods: {
    getTicketSubjectEditData() {
      this.getLoader = true;
      axios
        .get(this.globalVariables.apiUrl+`account-manager/tickets/${this.$route.params.id}/edit`, {
    ...
    SupportTicketsUpdate() {
      this.getLoader = true;
      axios
        .post(this.globalVariables.apiUrl+`account-manager/tickets/${this.$route.params.id}/update`, this.ticketCreate, {
          headers: { 
