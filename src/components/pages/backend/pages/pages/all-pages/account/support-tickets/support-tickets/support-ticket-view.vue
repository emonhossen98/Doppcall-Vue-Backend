                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="support-asset">
                                            <ul>
                                                <li><i class="far fa-clock fa-sm"></i> <span>{{ ticket.convat_open_date}}</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="bg-color">
                                                    <div class="row">
                                                            ...
                                                            <div class="content mt-2">
                                                                ...
                                                                <template v-if="ticket">
                                                                    <div class="support-action mt-2">
                                                                        <button type="button"  data-bs-toggle="modal" data-bs-target="#commentModal" @click="CommentEdit(value.id)" class="support-btn-account edit edit-btn border-0 me-2" data-id="{{ $value->id }}"><i class="far fa-edit"></i></button>
                                                                        <button type="button" @click="CommentDelete(value.id)" class="support-btn-delete-account border-0"><i class="far fa-trash-alt"></i></button>
                                                                    </div>
                                                                </template>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-2">
                                                            <div class="support-asset">
                                                                <ul>
                                                                    <li><i class="far fa-clock fa-sm"></i> <span>{{ value.convart_time }}</span></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <div class="radio-btn">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input status" @click="statusChange('Open')" type="radio" name="status" id="open" value="Open" :checked=" ticket.status == 'Open' ">
                            ...
                            <div class="support-info">
                                ...
                                <table class="w-100 mt-3 support-table">
                                    ...
                                    <tr  style="line-height:2rem">
                                        ...
                                        <td>{{ ticket.convat_open_date }}</td>
                                    </tr>
                                    <tr  style="line-height:2rem">
                                        <td><strong>Priority</strong></td>
                                        <td v-html="ticket.convat_priority"></td>
                                    </tr>
                                    <tr  style="line-height:2rem">
                                        <td><strong>Status</strong></td>
                                        <td v-html="ticket.convat_ticket"></td>
                                    </tr>
                                </table>
                                ...
                                <div class="ticket-close text-center mt-4">
                                    <template v-if="ticket.status == 'Open'">
                                        ...
                                        <template v-else>
                                        <button @click="updateStatus('Open',ticket.id)" class="btn btn-sm btn-info">Re-Open</button>
                                        </template>
                                </div>
                            </div>
                        </div>
...
export default {
  ...
  data() {
    return {
      breadcrumbs: [
        ...
        { label: "Support Tickets", url: "/account-tickets" },
        { label: "View", url: "" },
      ],
      getLoader: false,
      ticket: "",
  ...
  methods: {
    getTicketSubjectViewData() {
      ...
      axios
        .get(
          this.globalVariables.apiUrl+`account-manager/tickets/${this.$route.params.id}`,
          {
        ...
        .then((res) => {
          ...
          this.role = res.data.ticket.convart_role;
    ...
    replayComment() {
      ...
      axios
        .post(
          this.globalVariables.apiUrl+`account-manager/tickets/reply`,this.messageCreate,
          {
            headers: {
    ...
    updateStatus(status,id){
      this.getLoader = true;
          axios 
            .get(
              this.globalVariables.apiUrl+`account-manager/tickets/reply/status/${status}/${id}`,
              {
                headers: {
                  Authorization: "Bearer " + localStorage.getItem("token"),
                },
    ...
    CommentEdit(id) {
      ...
      axios
        .post(
          this.globalVariables.apiUrl+`account-manager/tickets/reply/edit`,this.editedData,
          {
            headers: {
              Authorization: "Bearer " + localStorage.getItem("token"),
            },
    ...
    commentUpdate(){
      ...
      axios
        .post(
          this.globalVariables.apiUrl+"account-manager/tickets/reply/update",
            this.editComment,
            {
              headers: {
                Authorization: "Bearer " + localStorage.getItem("token"),
    ...
    CommentDelete(id) {
      Swal.fire({
        ...
        if (result.value) {
          ...
          axios
            .get(
              this.globalVariables.apiUrl+`account-manager/tickets/reply/delete/${id}`,
              {
                headers: {
                  Authorization: "Bearer " + localStorage.getItem("token"),
                },
