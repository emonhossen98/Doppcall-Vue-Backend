                        ...
                        <div class="row px-3" id="externalFiltersWrapper">
                          <div class="col-md-6 border-right">
                            <ul class="px-0 mt-3" id="offer-extra-filter">
                              ...
                              <li class="position-relative">
                                <a :class="checkfilter.showcolumn == 'Short Title' ? 'check-active' : ''"
                                  @click="clickFilters('short_title', 'search', 'Short Title')">Short Title
                                </a>
                                <template v-if="applyfillters.includes('Short Title')">
                                  <span @click="removeSearch('Short Title', 'short_title', 'search')"
                                    id="remove-to-search-list">x</span>
                                </template>
                              </li>
                              <li class="position-relative">
                          ...
                          <div class="col-md-6 ps-4">
                            <div v-if="checkfilter.showcolumn != null && checkfilter.showcolumn != ''">
                              ...
                              <template v-if="checkfilter.showcolumn == 'Short Title' && checkfilter.types.includes('search')">
                                <div class="form-check mb-2">
                                  <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                                    v-model="checkfilter.emptyValues['short_title']" type="checkbox" value="1"
                                    id="isemptyvalue">
                                  <label class="form-check-label" for="isemptyvalue">
                                    is Empty
                                  </label>
                                ...
                                <div class="form-check mb-2">
                                  <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                                    v-model="checkfilter.notemptyValues['short_title']" type="checkbox" value="0"
                                    id="isnotemptyvalue">
                                  <label class="form-check-label" for="isnotemptyvalue">
                                    is not Empty
                                  </label>
                              ...
                              <div>
                                ...
                                <div>
                                  ...
                                  <template v-if="checkfilter.showcolumn == 'Short Title' && checkfilter.types.includes('search')">
                                    <label for="filtertext">Contains</label>
                                    <input type="text" @keyup="clickCheckboxFilters(checkfilter.showcolumn)"
                                      v-model="checkfilter.searchValues['short_title']" class="form-control mb-2"
                                      id="filtertext" placeholder="Search here..">
                                  </template>
                                  <template v-if="checkfilter.showcolumn == 'Created At' && checkfilter.types.includes('search')">
                                    <label for="filtertext">Contains</label>
...
export default {
  ...
  methods: {
        ...
        .then((res) => {
          ...
          $('#how_to_work_tables').DataTable().destroy();
            ...
            var table = $('#how_to_work_tables').DataTable({
              ...
              initComplete: () => { 
                $('#how_to_work_tables').wrap('<div class="commonDataTablesClass"></div>');
                const table = $("#how_to_work_tables").DataTable();
    ...
    getFiltarOfExtranalFilter(perPage = 10,) {
          axios
            .post(
              this.globalVariables.apiUrl + "admin/appearance/howtowork-search-get-data-all-filter",
              this.checkfilter,
              {
