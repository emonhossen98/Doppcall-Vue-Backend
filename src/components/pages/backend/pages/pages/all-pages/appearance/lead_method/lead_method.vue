              ...
              columnDefs: [
                ...
                },
                {
                  ...
                  render: function (data, type, full, meta) {
                    return '<div class="lead_action d-flex align-items-center"><button type="button" id="edit-btn" class="btn-style-edit me-2 d-flex  align-items-center" data-id='+full.id+'><i id="edit-btn" class="far fa-edit fa-sm" data-id='+full.id+'></i></button><button type="button" id="delete-btn"  data-id='+full.id +' class="btn-style-danger"><i class="far fa-trash-alt fa-sm" id="delete-btn" data-id='+full.id +'></i></button></div>';
                  }
                }
              ],
              order: [[2, 'desc']],
    ...
    attachEventListeners() {
      $("#lead_method_tables").on("click", ".lead_action", (event) => {
        ...
        if(dataClass === 'edit-btn'){
         this.$router.push('/admin-appearance-leadmethod-edit/'+dataId);
