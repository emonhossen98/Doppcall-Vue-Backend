                ...
                <div class="card">
                  <div class="card-body">
                    <div class="mb-3">
                      ...
                      <input type="text"  v-model="pageCreate.name" id="name"  required class="form-control" placeholder="Enter Name"/>
                    ...
                    <textarea id="LarabergId" v-model="pageCreate.content" hidden></textarea>
                    ...
                    <div>
                      <div class="text-end">
                        <button type="button" @click="pageSave()" class="btn btn-primary me-2 text-capitalize btn-sm">
                        Submit
                      </button>
                      </div>
                    </div>
...
export default {
  ...
  methods: {
    pageSave() {
      ...
      axios
        .post(
          this.globalVariables.apiUrl+"author/pages/store",
          this.pageCreate,
          {
            headers: {
