          ...
          <div class="col-md-12 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0 mt-2">Industry Verticals Create</h5>
                </div>
                <div class="card-body">
                    <form>
                        <div class="row-mb">
...
export default {
  ...
  methods: {
    industrySave(){
      this.getLoader = true;
        axios.post(this.globalVariables.apiUrl+"admin/contacts/industry-verticals/store", this.industryData, {
          headers: {
