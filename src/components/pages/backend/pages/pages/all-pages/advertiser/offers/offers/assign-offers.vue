                  ...
                  <div class="row px-3" id="externalFiltersWrapper">
                      ...
                      <ul class="px-0 mt-3" id="offer-extra-filter">
                        ...
                        <li class="position-relative">
                          <a :class="checkfilter.showcolumn == 'Primary Country' ? 'check-active' : ''"
                            @click="clickFilters('primary_country', 'search', 'Primary Country')">Primary Country
                          </a>
                          <template v-if="applyfillters.includes('Primary Country')">
                            <span @click="removeSearch('Primary Country', 'primary_country', 'search')"
                        ...
                        <li class="position-relative">
                          <a :class="checkfilter.showcolumn == 'Offers Type' ? 'check-active' : ''"
                            @click="clickFilters('offer_type', 'search', 'Offers Type')">Offers Type
                          </a>
                          <template v-if="applyfillters.includes('Offers Type')">
                            <span @click="removeSearch('Offers Type', 'offer_type', 'search')"
                              id="remove-to-search-list">x</span>
                          </template>
                        </li>
                        ...
                        <li class="position-relative">
                          <a :class="checkfilter.showcolumn == 'Payout' ? 'check-active' : ''"
                            @click="clickFilters('payout', 'search', 'Payout')">Payout
                          </a>
                          <template v-if="applyfillters.includes('Payout')">
                            <span @click="removeSearch('Payout', 'payout', 'search')"
                              id="remove-to-search-list">x</span>
                          </template>
                        </li>
                    ...
                    <div class="col-md-6 ps-4">
                      <div v-if="checkfilter.showcolumn != null && checkfilter.showcolumn != ''">
                        ...
                        <template v-if="checkfilter.showcolumn == 'ID' && checkfilter.types.includes('search')">
                          <div class="form-check mb-2">
                            <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                              v-model="checkfilter.emptyValues['id']" type="checkbox" value="1" id="isemptyvalue">
                        ...
                        <template
                          v-if="checkfilter.showcolumn == 'Primary Country' && checkfilter.types.includes('search')">
                          <div class="form-check mb-2">
                            <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                        ...
                        <template
                          v-if="checkfilter.showcolumn == 'Offers Type' && checkfilter.types.includes('search')">
                          <div class="form-check mb-2">
                            <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                              v-model="checkfilter.emptyValues['offer_type']" type="checkbox" value="1"
                              id="isemptyvalue">
                            <label class="form-check-label" for="isemptyvalue">
                              is Empty
                            </label>
                          ...
                          <div class="form-check mb-2">
                            <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                              v-model="checkfilter.notemptyValues['offer_type']" type="checkbox" value="0"
                              id="isnotemptyvalue">
                            <label class="form-check-label" for="isnotemptyvalue">
                              is not Empty
                            </label>
                        ...
                        <template v-if="checkfilter.showcolumn == 'Payout' && checkfilter.types.includes('search')">
                          <div class="form-check mb-2">
                            <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                              v-model="checkfilter.emptyValues['payout']" type="checkbox" value="1" id="isemptyvalue">
                            <label class="form-check-label" for="isemptyvalue">
                              is Empty
                            </label>
                          </div>
                          <div class="form-check mb-2">
                            <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                              v-model="checkfilter.notemptyValues['payout']" type="checkbox" value="0"
                              id="isnotemptyvalue">
                            <label class="form-check-label" for="isnotemptyvalue">
                              is not Empty
                            </label>
                          ...
                          <div>
                            ...
                            <template v-if="checkfilter.showcolumn == 'ID' && checkfilter.types.includes('search')">
                              ...
                              <input type="text" @keyup="clickCheckboxFilters(checkfilter.showcolumn)"
                                v-model="checkfilter.searchValues['id']" class="form-control mb-2" id="filtertext"
                            ...
                            <template
                              ...
                              <label for="filtertext">Contains</label>
                              <input type="text" @keyup="clickCheckboxFilters(checkfilter.showcolumn)"
                                v-model="checkfilter.searchValues['primary_country']" class="form-control mb-2"
                            ...
                            <template
                              ...
                              <label for="filtertext">Contains</label>
                              <input type="text" @keyup="clickCheckboxFilters(checkfilter.showcolumn)"
                                v-model="checkfilter.searchValues['offer_type']" class="form-control mb-2"
                                id="filtertext" placeholder="Search here..">
                            </template>
                            ...
                            <template v-if="checkfilter.showcolumn == 'Payout' && checkfilter.types.includes('search')">
                              <label for="filtertext">Contains</label>
                              <input type="text" @keyup="clickCheckboxFilters(checkfilter.showcolumn)"
                                v-model="checkfilter.searchValues['payout']" class="form-control mb-2" id="filtertext"
                                placeholder="Search here..">
                            </template>
...
export default {
  ...
  methods: {
    ...
    getAdvertiserOffers() {
      this.getLoader = true;
      axios
        .get(this.globalVariables.apiUrl + "advertiser/offers/assign-get-data", {
          headers: { Authorization: "Bearer " + localStorage.getItem("token") },
        })
        .then((res) => {
    ...
    getFiltarOffers() {
      if (this.filtarData.country === "" && this.filtarData.category === "" && this.filtarData.type === "") {
        ...
        this.getLoader = true;
        axios
          .post(this.globalVariables.apiUrl + "advertiser/offers/assign-get-data/search", this.filtarData, {
            headers: { Authorization: "Bearer " + localStorage.getItem("token") },
          })
          .then((res) => {
            if ($.fn.DataTable.isDataTable('#advertiser_offers_datatables')) {
