<template>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 mb-3 mb-md-0">
                                <div class="card-border mb-0 rounded-0">
                                        ...
                                        <table class="table table-sm mb-0">
                                            <tbody>
                                                ...
                                                <template v-if="userRole && userRole.role && userRole.role.name == 'Advertiser'">
                                                    ...
                                                    <tr>
                                                        <td class="pl-0"><h6 class="card-title font-class">Buyer:</h6></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><p class="mb-0">{{ history.description ?? '--' }}</p></td>
                                                </tr>
                                                <template v-if="userRole && userRole.role && userRole.role.name == 'Advertiser'">
                                                    <tr>
  ...
  export default {
    ...
    data() {
      return {
        breadcrumbs: [
          ...
          { label: "Account", url: "/advertiser-account" },
    ...
    try {
      ...
      if (role == 'Advertiser') {
        this.getAdvertisherPaymnetInfo();
      }
    } catch (error) {
    ...
    methods: {
      getAdvertisherPaymnetInfo() {
        this.getLoader = true;
        axios
          .get(this.globalVariables.apiUrl+`advertiser/payment-history/details/${this.$route.params.id}`, { headers: { Authorization: "Bearer " + localStorage.getItem("token") },
          })
          .then((res) => {
