                                    ...
                                    <div class="col-md-6 border-right">
                                      <ul class="px-0 mt-3" id="offer-extra-filter">
                                          ...
                                          <template v-if="applyfillters.includes('ID')">
                                            <span @click="removeSearch('ID', 'id', 'search')"
                                    ...
                                    <div class="col-md-6 ps-4">
                                      <div v-if="checkfilter.showcolumn != null && checkfilter.showcolumn != ''">
                                        <p class="mt-3 mb-1 font-class">{{ checkfilter.showcolumn ?? '' }}</p>
                                          ...
                                          <template
                                          v-if="checkfilter.showcolumn == 'ID' && checkfilter.types.includes('search')">
                                          <div class="form-check mb-2">
                                            <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                                              v-model="checkfilter.emptyValues['id']" type="checkbox" value="1"
                                              id="isemptyvalue">
                                          ...
                                          <div class="form-check mb-2">
                                            <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                                              v-model="checkfilter.notemptyValues['id']" type="checkbox" value="0"
                                              id="isnotemptyvalue">
                                          ...
                                          <div>
                                             ...
                                             <template
                                              ...
                                              <input type="text" @keyup="clickCheckboxFilters(checkfilter.showcolumn)"
                                                v-model="checkfilter.searchValues['id']" class="form-control mb-2"
