                    ...
                    <div class="card-body pt-0">
                        <form>
                            <div class="row-mb-15">
                                <div class="row mt-4">
                                    <div class="col-md-4">
                                        <label for="subjects" class="mb-1">Subject<span class="text-danger">*</span></label>
...
export default {
  ...
  methods: {
    getTicketSubject() {
      this.getLoader = true;
      axios
        .get(this.globalVariables.apiUrl+"advertiser/support-tickets/create", {
    ...
    SupportTicketsSave() {
      this.getLoader = true;
      axios
        .post(this.globalVariables.apiUrl+"advertiser/support-tickets/store", this.ticketCreate, {
          headers: { 
