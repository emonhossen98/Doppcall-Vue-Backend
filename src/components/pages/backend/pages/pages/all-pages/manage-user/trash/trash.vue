                    ...
                    <div class="row px-3" id="externalFiltersWrapper">
                      <div class="col-md-6 border-right">
                        <ul class="px-0 mt-3" id="offer-extra-filter">
                          ...
                          <li class="position-relative">
                            <a :class="checkfilter.showcolumn == 'Deleted At' ? 'check-active' : ''"
                              @click="clickFilters('deleted_at', 'search', 'Deleted At')">Deleted At 
                            </a>
                            <template v-if="applyfillters.includes('Deleted At')">
                              <span @click="removeSearch('Deleted At','deleted_at','search')" id="remove-to-search-list">x</span>
                            </template>
                          </li>
                        </ul>
                      </div>
                      <div class="col-md-6 ps-4">
                        <div v-if="checkfilter.showcolumn != null && checkfilter.showcolumn != ''">
                          ...
                          <template v-if="checkfilter.showcolumn == 'Deleted At' && checkfilter.types.includes('search')"> 
                            <div class="form-check mb-2">
                              <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)" v-model="checkfilter.emptyValues['deleted_at']"
                                type="checkbox" value="1" id="isemptyvalue">
                              <label class="form-check-label" for="isemptyvalue">
                                is Empty
                              </label>
                            ...
                            <div class="form-check mb-2">
                              <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                                v-model="checkfilter.notemptyValues['deleted_at']" type="checkbox" value="0" id="isnotemptyvalue">
                              <label class="form-check-label" for="isnotemptyvalue">
                                is not Empty
                              </label>
                            </div>
                          ...
                          <div>
                            ...
                            <div>
                              ...
                              <template v-if="checkfilter.showcolumn == 'Deleted At' && checkfilter.types.includes('search')">
                                <label for="filtertext">Contains</label>
                                <input type="text" @keyup="clickCheckboxFilters(checkfilter.showcolumn)" v-model="checkfilter.searchValues['deleted_at']"
                                  class="form-control mb-2" id="filtertext" placeholder="Search here..">
                              </template>
                            </div>
                          </div>
...
export default {
  ...
  methods: {
    getUserTrashs() {
      ...
      axios
        ...
        var table = $('#trashs_datatables').DataTable({
          ...
          initComplete: () => { 
            $('#trashs_datatables').wrap('<div class="commonDataTablesClass"></div>');
    ...
    attachEventListenersOfButton() {
      $("#trashs_datatables_wrapper").on("click", "button", (event) => {
    ...
    axios
      .post(
        this.globalVariables.apiUrl + "admin/manage/user/trash/search-get-data-all-filter",
        this.checkfilter,
        {
          headers: { Authorization: "Bearer " + localStorage.getItem("token") }
        }
