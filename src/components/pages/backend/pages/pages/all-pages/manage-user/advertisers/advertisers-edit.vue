      ...
      <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="row mt-4">
            <div class="app-main__inner">
                <form >
                    <input type="hidden" v-model="advertisherEditData.update_id" />
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" v-model="advertisherEditData.first_name" id="first_name" class="form-control" required placeholder="Enter First Name"/>
                                        </div>
                                        <div class="col-md-6 mt-3 mt-md-0">
                                            <label for="last_name" class="required mb-1">Last Name</label>
                                            <input type="text" v-model="advertisherEditData.last_name" id="last_name" class="form-control" required placeholder="Enter Last Name"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="my-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" v-model="advertisherEditData.company_name" id="company_name" class="form-control" required placeholder="Enter Company Name"/>
                                        </div>
                                        <div class="form-group mt-3">
                                            <label for="email" class="required mb-1">E-mail</label>
                                            <input type="email" v-model="advertisherEditData.email" id="email" class="form-control" required placeholder="Enter E-mail"/>
                                        </div>
                                        <div class="form-group mt-3">
                                            <label for="phone_number" class="required mb-1">Phone Number</label>
                                            <input type="text" v-model="advertisherEditData.phone_number" id="phone_number" class="form-control" required placeholder="Enter Phone Number"/>
                                        </div>
                                    </div>
                                    <!-- {{ Users.role.name }} -->
                                    <div class="my-3 account-manager-data" :class="Users === 'Account' ? '' : 'd-none'">
                                        <div class="form-group mt-3">
                                            ...
                                            <input type="text" v-model="advertisherEditData.skype" id="skype" class="form-control" required placeholder="Enter Skype">
                                        </div>
                                        <div class="form-group mt-3">
                                            <label for="telegram" class="required mb-1">Telegram</label>
                                            <input type="text" v-model="advertisherEditData.telegram" id="telegram" class="form-control" required placeholder="Enter Telegram">
                                        </div>
                                        <div class="form-group mt-3">
                                            <label for="facebook" class="required mb-1">Facebook</label>
                                            <input type="text" v-model="advertisherEditData.facebook" id="facebook" class="form-control" required placeholder="Enter Facebook">
                                        </div>
                                        <div class="form-group mt-3">
                                            <label for="available_time" class="required mb-1">Available time</label>
                                            <input type="text" v-model="advertisherEditData.available_time" id="available_time" class="form-control" required placeholder="Enter Available time">
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <select v-model="advertisherEditData.role_name" id="role_name" class="form-select">
                                    ...
                                    <!-- <div class="form-group mt-3">
                                        ...
                                        <select v-model="advertisherEditData.profile_editable" id="profile_editable" class="form-select">
                                            ...
                                            <option value="0" :selected="advertisherEditData.profile_editable == 0">Pending</option>
                                            <option value="1" :selected="advertisherEditData.profile_editable == 1">Approved</option>
                                        </select>
                                    </div>

                                    <div class="form-group mt-3">
                                    <label for="verifiable" class="required mb-1">Verifiable</label>
                                    <select v-model="advertisherEditData.verifiable" id="verifiable" class="form-select">
                                        <option value="">Select Please</option>
                                        <option :value="currentTime" :selected="advertisherEditData.verifiable != null">Verified</option>
                                        <option value="NULL" :selected="advertisherEditData.verifiable == null">Unverified</option>
                                    </select>
                                    </div>

                                    <div class="form-group mt-3">
                                        <label for="accessable" class="required mb-1">Accessable</label>
                                        <select v-model="advertisherEditData.accessable" id="accessable" class="form-select">
                                            <option value="">Select Please</option>
                                            <option value="1" :selected="advertisherEditData.accessable == 1">Pending</option>
                                            <option value="2" :selected="advertisherEditData.accessable == 2">Approved</option>
                                ...
                                <div class="form-group mt-3">
                                  <div class="form-check form-switch">
                                    ...
                                    <div class="form-group mt-3 row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="file" accept="image/*" ref="myFile" @change="advertisrEditedImage($event)" class="form-control" id="profile_image">
            ...
            <div class="modal-dialog modal-md modal-center" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5 class="mb-0">Password Change To : {{ advertisherEditData.first_name }}</h5>
                ...
                <div class="modal-footer">
                  ...
                  <button @click="advertisherPasswordUpdate()" type="button" class="btn btn-primary btn-sm"> <i class="fas fa-check fa-sm me-2"></i> Confirm</button>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    publisherUpdate() {
        this.getLoader = true;
        this.advertisherEditData.offers = this.selectedIndustrie;
      axios
        .post(this.globalVariables.apiUrl+`admin/manage/user/${this.update_id}/update`, this.advertisherEditData, {
          headers: { 
            Authorization: "Bearer " + localStorage.getItem("token"),
    ...
    getpublisherData() {
      ...
      axios
        ...
        this.advertisherEditData.first_name = res.data.user.fname;
        this.advertisherEditData.last_name = res.data.user.lname;
        this.advertisherEditData.company_name = res.data.user.company_name;
        this.advertisherEditData.email = res.data.user.email;
        this.advertisherEditData.phone_number = res.data.user.phone_no;
        this.advertisherEditData.skype = res.data.user.skype;
        this.advertisherEditData.telegram = res.data.user.telegram;
        this.advertisherEditData.facebook = res.data.user.facebook;
        this.advertisherEditData.available_time = res.data.user.available_time;
    ...
    advertisrEditedImage(event) {
      const file = event.target.files[0];
      this.advertisherEditData.profile_image = file;
