                      ...
                      <ul class="px-0 mt-3" id="offer-extra-filter">
                        ...
                        <li class="position-relative">
                          ...
                          <template v-if="applyfillters.includes('Type')">
                            <span @click="removeSearch('Type', 'type', 'select')"
                              id="remove-to-search-list">x</span>
                          </template>
                        </li>
                      </ul>
                    ...
                    <div class="col-md-6 ps-4">
                      <div v-if="checkfilter.showcolumn != null && checkfilter.showcolumn != ''">
                        ...
                        <template v-if="checkfilter.showcolumn == 'Type' && checkfilter.types.includes('search')">
                          <div class="form-check mb-2">
                            <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                              v-model="checkfilter.emptyValues['type']" type="checkbox" value="1"
                              id="isemptyvalue">
                            <label class="form-check-label" for="isemptyvalue">
                              is Empty
                            </label>
                          ...
                          <div class="form-check mb-2">
                            <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                              v-model="checkfilter.notemptyValues['type']" type="checkbox" value="0"
                              id="isnotemptyvalue">
                            <label class="form-check-label" for="isnotemptyvalue">
                              is not Empty
                            </label>
                            ...
                            <template v-if="checkfilter.showcolumn == 'Type' && checkfilter.types.includes('select')">
                                <div class="form-check mb-2">
                                  <input @change="clickCheckboxFilters(checkfilter.showcolumn)"
                                    v-model="checkfilter.selectedValues['type']" class="form-check-input"
                                    type="checkbox" value="1" id="dynamicidtype1">
                                  <label class="form-check-label" for="dynamicidtype1">
                                    Person
                                  </label>
                                </div>
                                <div class="form-check mb-2">
                                  <input @change="clickCheckboxFilters(checkfilter.showcolumn)"
                                    v-model="checkfilter.selectedValues['type']" class="form-check-input"
                                    type="checkbox" value="2" id="dynamicidtype2">
                                  <label class="form-check-label" for="dynamicidtype2">
                                    Legal Entity
                                  </label>
                                </div>
                              </template>
              ...
              <div class="pagination-controls col-md-9 d-flex justify-content-end align-items-center ">
                <ul class="pagination mb-0">
                  ...
                  <li class="paginate_button page-item previous" :class="{ disabled: currentPage === 1 }">
                    <button class="page-link" @click="getUserActivities(currentPage - 1)" :disabled="currentPage === 1" >
                  ...
                  <template v-for="page in paginationPages" :key="page">
                    <li class="paginate_button page-item" :class="{ active: page === currentPage }">
                      <button class="page-link" @click="getUserActivities(page)">
                        {{ page }}
                      </button>
                    </li>
                  </template>
                  ...
                  <li class="paginate_button page-item next" :class="{ disabled: currentPage === lastPage }">
                    <button  class="page-link" @click="getUserActivities(currentPage + 1)" :disabled="currentPage === lastPage">
...
export default {
  ...
  methods: {
    ...
    getUserActivities(page = 1, perPage = 10,searchValue = '') {
      this.getLoader = true;
      axios
    ...
    attachEventListenersOfButton(){
      $("#user_activiti_table_wrapper").on("click", "button", (event) => {
    ...
    getFiltarOfExtranalFilter(perPage = 10,) {
          axios
            .post(
              this.globalVariables.apiUrl + "admin/dashboard-search-get-data-all-filter",
              this.checkfilter,
              {
                headers: { Authorization: "Bearer " + localStorage.getItem("token") }
              }
