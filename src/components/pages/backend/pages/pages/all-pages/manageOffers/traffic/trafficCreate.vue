        ...
        <div class="col-md-8 mx-auto">
          <div class="card">
            <div class="card-header custom-card-header">
              <h5 class="card-title">Allow Traffic Create</h5>
            </div>
            <div class="card-body">
              <form>
                <div class="row align-items-center">
                  ...
                  <div class="col-sm-10">
                    <input type="text" v-model="offersTrafficCreate.name" class="form-control" placeholder="Enter Traffic Name !"/>
  ...
  data: () => {
    return {
      ...
      breadcrumbs: [
        ...
        { label: "Allow Traffic Create", url: "" },
      ],
