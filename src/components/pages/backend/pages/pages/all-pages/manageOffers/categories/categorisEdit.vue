<template>
          ...
          <div class="row mt-4">
              ...
              <div class="card">
                  <div class=" border-bottom">
                      <h5 class="mb-0 px-3 py-3">Offer Category Edit</h5>
                  </div>
                  <div class="card-body mt-3">
                      <form>
                          ...
                          <div class="form-group text-end mt-3">
                              <button type="button" @click="offersCategoriesUpdate" class="btn btn-sm btn-primary">Update</button>
                          </div>
                      </form>
                  </div>
              </div>
  ...
  export default {
    ...
    methods: {
      offersCategoriesUpdate() {
        this.getLoader = true,
        axios 
          .post(this.globalVariables.apiUrl+`admin/offers/categories/update/${this.$route.params.id}`, this.offersCategoeieCreate, {
      ...
      getCategorieEdit() {
        this.getLoader = true,
        axios
          .get(this.globalVariables.apiUrl+`admin/offers/categories/edit/${this.$route.params.id}`, {
            headers: { Authorization: "Bearer " + localStorage.getItem("token") },
          })
          .then((res) => {
