                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group mt-4">
                      ...
                      <input
                        type="text"
                        v-model="PostCreated.slug"
                        id="slug"
                        required
                        class="form-control"
                      />
                      <div
                        v-if="validationErrors && validationErrors.slug"
                        class="text-danger"
                      >
                    ...
                    <div class="form-group mt-4">
                      ...
                      <textarea
                        v-model="PostCreated.description"
                        id="description"
                        cols="30"
                        rows="4"
                        maxlength="150"
                    ...
                    <div class="form-group mt-4">
                      ...
                      <input
                        type="text"
                        v-model="PostCreated.meta_title"
                        id="meta_title"
                        required
                        class="form-control"
                        maxlength="60"
                    ...
                    <div class="form-group mt-4">
                      ...
                      <textarea
                        v-model="PostCreated.meta_description"
                        id="meta_description"
                        cols="30"
                        rows="5"
                        class="form-control"
                  ...
                  <div class="card-body">
                    <div class="category-items">
                      <ul class="m-0 p-0 list-unstyled">
                        <li
                          v-for="(categorie, index) in postEditData.categories"
                          :key="index"
                        >
                          <div class="form-check">
                            <input
                              type="checkbox"
                              checked
                              v-model="PostCreated.categories"
                              :value="categorie.id"
                              :id="'categories-' + categorie.id"
                              class="form-check-input"
                            />
                            <label
                              :for="'categories-' + categorie.id"
                      ...
                      <div
                        v-if="validationErrors && validationErrors.categories"
                        class="text-danger"
                      >
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <img
                          v-if="showPostImage.image"
                          :src="showPostImage.image"
                          class="largeImage"
                        />
                      </div>
                      <div
...
export default {
  ...
  data: () => {
    return {
      breadcrumbs: [
        ...
        { label: "Press Posts", url: "/admin-press-posts" },
        { label: "Edit", url: "" },
      ],
      getLoader: false,
      PostCreated: {
  ...
  methods: {
    getPostEditData() {
      ...
      axios
        .get(
          this.globalVariables.apiUrl + `admin/pressPost/edit/${this.$route.params.id}`,
          {
            headers: {
        ...
        .then((res) => {
          ...
          this.PostCreated.post_update_id = res.data.press_post.id;
          this.PostCreated.title = res.data.press_post.title;
          this.PostCreated.slug = res.data.press_post.slug;
          this.PostCreated.description = res.data.press_post.description;
          this.PostCreated.content = res.data.press_post.body;
          this.PostCreated.meta_title = res.data.press_post.meta_title;
          this.PostCreated.meta_description = res.data.press_post.meta_description;
          this.PostCreated.status = res.data.press_post.status;
          if (
            res.data.categories &&
          ...
          $(this.$refs.Content).summernote("code", res.data.press_post.body ?? "");
          this.showPostImage.image =
            this.globalVariables.appUrl + res.data.press_post.feature_image;
        })
        .catch((error) => {
          console.log(error);
        })
      ...
      axios
        .post(
          this.globalVariables.apiUrl +
            `admin/pressPost/update/${this.$route.params.id}`,
          this.PostCreated,
          {
            headers: {
              Authorization: "Bearer " + localStorage.getItem("token"),
        ...
        .then((res) => {
          ...
          this.$router.push("/admin-press-posts");
        })
        .catch((error) => {
          if (
            error &&
