...
export default {
  ...
  methods: {
    getPublisherRingbaLogin() {
      this.getLoader = true;
      axios 
        .get(this.globalVariables.apiUrl+"publisher/alternative-ringba", {
          headers: { Authorization: "Bearer " + localStorage.getItem("token") },
        })
        .then((res) => {
          this.alt_ringba_url = res.data.alt_ringba_url;
        })
        .catch((error) => {
          console.log(error);
        })
