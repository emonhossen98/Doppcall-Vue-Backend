            ...
            <div class="row mt-4">
                ...
                <div class="card">
                    <div class="card-header py-3">
                        <h5 class="card-title mb-0">New Support Ticket Edit</h5>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="row-mb-15">
...
export default {
  ...
  methods: {
    getTicketSubjectEditData() {
      this.getLoader = true;
      axios
        .get(this.globalVariables.apiUrl+`publisher/support-tickets/edit/${this.$route.params.id}`, {
    ...
    SupportTicketsUpdate() {
      this.getLoader = true;
      axios
        .post(this.globalVariables.apiUrl+`publisher/support-tickets/update/${this.$route.params.id}`, this.ticketCreate, {
          headers: { 
