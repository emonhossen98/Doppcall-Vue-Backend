  ...
  setup() {
   ...
   methods: {
     getMediaData() {
       ...
       axios
         .get(
          this.globalVariables.apiUrl+`admin/settings/media/edit/${this.$route.params.id}`,
           {
             headers: {
     ...
     mediaSave() {
       ...
       axios
         .post(
          this.globalVariables.apiUrl+`admin/settings/media/update/${this.$route.params.id}`,
