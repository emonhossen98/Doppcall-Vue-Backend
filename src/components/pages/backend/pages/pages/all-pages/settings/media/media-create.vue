      ...
      <div class="row mt-4">
          ...
          <div class="card">
              <div class="card-header">
                  <h5 class="card-title mb-0">Media Create</h5>
              </div>
              <div class="card-body">
                  <form>
                      <div class="row-mb">
                          <div class="row mb-4">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" v-model="mediaCreateData.title" id="title" class="form-control" required placeholder="Enter Title">
...
export default {
  ...
  data() {
    return {
      breadcrumbs: [
        ...
        { label: "Settings", url: "" },
        { label: "Media", url: "/admin-settings-media" },
        { label: "Create", url: "" },
      ],
      getLoader: false,
      mediaCreateData: {
  ...
  methods: {
    mediaSave() {
      ...
      axios
        .post(
          this.globalVariables.apiUrl+"admin/settings/media/store",
        ...
        .then((res) => {
          ...
          this.$router.push('/admin-settings-media');
        })
        .catch((error) => {
