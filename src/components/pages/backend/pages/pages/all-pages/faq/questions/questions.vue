                          ...
                          <div class="row px-3" id="externalFiltersWrapper">
                            <div class="col-md-6 border-right">
                              <ul class="px-0 mt-3" id="offer-extra-filter">
                                <li class="position-relative">
                                  <a :class="checkfilter.showcolumn == 'Faq Qustion' ? 'check-active' : ''"
                                    @click="clickFilters('faq_qustion', 'search', 'Faq Qustion')">Faq Qustion
                                  </a>
                                  <template v-if="applyfillters.includes('Faq Qustion')">
                                    <span @click="removeSearch('Faq Qustion', 'faq_qustion', 'search')"
                                      id="remove-to-search-list">x</span>
                                  </template>
                                </li>
                                <li class="position-relative">
                                  <a :class="checkfilter.showcolumn == 'Service' ? 'check-active' : ''"
                                    @click="clickFilters('faqservice_id', 'select', 'Service')">Service <i class="fa-solid fa-caret-down"></i>
                                  </a>
                                  <template v-if="applyfillters.includes('Service')">
                                    <span @click="removeSearch('Service', 'faqservice_id', 'select')" id="remove-to-search-list">x</span>
                                  </template>
                                </li>
                                <li class="position-relative">
                                  <a :class="checkfilter.showcolumn == 'Faq Answer' ? 'check-active' : ''"
                                    @click="clickFilters('faq_ans', 'search', 'Faq Answer')">Faq Answer
                                  </a>
                                  <template v-if="applyfillters.includes('Faq Answer')">
                                    <span @click="removeSearch('Faq Answer', 'faq_ans', 'search')"
                                      id="remove-to-search-list">x</span>
                                  </template>
                                </li>
                                <li class="position-relative">
                            ...
                            <div class="col-md-6 ps-4">
                              <div v-if="checkfilter.showcolumn != null && checkfilter.showcolumn != ''">
                                ...
                                <template v-if="checkfilter.showcolumn == 'Faq Qustion' && checkfilter.types.includes('search')">
                                  <div class="form-check mb-2">
                                    <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                                      v-model="checkfilter.emptyValues['faq_qustion']" type="checkbox" value="1"
                                      id="isemptyvalue">
                                  ...
                                  <div class="form-check mb-2">
                                    <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                                      v-model="checkfilter.notemptyValues['faq_qustion']" type="checkbox" value="0"
                                      id="isnotemptyvalue">
                                ...
                                <template v-if="checkfilter.showcolumn == 'Service' && checkfilter.types.includes('select')">
                                <div class="form-check mb-2">
                                  <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                                    v-model="checkfilter.emptyValues['faqservice_id']" type="checkbox" value="1" id="isemptyvalue">
                                  <label class="form-check-label" for="isemptyvalue">
                                    is Empty
                                  </label>
                                </div>
                                <div class="form-check mb-2">
                                  <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                                    v-model="checkfilter.notemptyValues['faqservice_id']" type="checkbox" value="0"
                                    id="isnotemptyvalue">
                                  <label class="form-check-label" for="isnotemptyvalue">
                                    is not Empty
                                  </label>
                                ...
                                <template v-if="checkfilter.showcolumn == 'Faq Answer' && checkfilter.types.includes('search')">
                                  <div class="form-check mb-2">
                                    <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                                      v-model="checkfilter.emptyValues['faq_ans']" type="checkbox" value="1"
                                      id="isemptyvalue">
                                    <label class="form-check-label" for="isemptyvalue">
                                      is Empty
                                    </label>
                                  ...
                                  <div class="form-check mb-2">
                                    <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                                      v-model="checkfilter.notemptyValues['faq_ans']" type="checkbox" value="0"
                                      id="isnotemptyvalue">
                                    <label class="form-check-label" for="isnotemptyvalue">
                                      is not Empty
                                    </label>
                                  ...
                                  <div>
                                    <template v-if="checkfilter.showcolumn == 'Faq Qustion' && checkfilter.types.includes('search')">
                                      ...
                                      <input type="text" @keyup="clickCheckboxFilters(checkfilter.showcolumn)"
                                        v-model="checkfilter.searchValues['faq_qustion']" class="form-control mb-2"
                                        id="filtertext" placeholder="Search here..">
                                    </template>
                                    <template v-if="checkfilter.showcolumn == 'Service' && checkfilter.types.includes('select')">
                                      <template v-if="faqServices.length > 0">
                                        <template v-for="(service, index) in faqServices" :key="index">
                                          <div class="form-check mb-2">
                                            <input @change="clickCheckboxFilters(checkfilter.showcolumn)"
                                              v-model="checkfilter.selectedValues['faqservice_id']" class="form-check-input"
                                              type="checkbox" :value="service.id" :id="'dynamicidstatus'+service.id">
                                            <label class="form-check-label" :for="'dynamicidstatus'+service.id">
                                    ...
                                    <template v-if="checkfilter.showcolumn == 'Faq Answer' && checkfilter.types.includes('search')">
                                      <label for="filtertext">Contains</label>
                                      <input type="text" @keyup="clickCheckboxFilters(checkfilter.showcolumn)"
                                        v-model="checkfilter.searchValues['faq_ans']" class="form-control mb-2"
                                        id="filtertext" placeholder="Search here..">
                                    </template>
                                    <template v-if="checkfilter.showcolumn == 'Status' && checkfilter.types.includes('select')">
                                      <div class="form-check mb-2">
...
async mounted() { 
  ...
  methods: {
    getQuestionsData(page = 1, perPage = 10,searchValue = '') {
      ...
      axios
        ...
        .then((res) => {
          ...
          this.faqServices = res.data.faqServices;
    ...
    externalfilterreset(){
      this.checkfilter.columns = ['faq_qustion'],
      this.checkfilter.showcolumn = "Faq Qustion",
    ...
    getFiltarOfExtranalFilter(perPage = 10,) {
          axios
            .post(
              this.globalVariables.apiUrl + "admin/faq/questions-services-search-get-data-all-filter",
              this.checkfilter,
              {
                headers: { Authorization: "Bearer " + localStorage.getItem("token") }
              }
