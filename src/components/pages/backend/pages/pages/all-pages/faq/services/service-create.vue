        ...
        <div class="row mt-4">
            ...
            <div class="card ">
                <div class="card-header">
                    <h5 class="card-title mb-0 mt-2">New Create FAQ</h5>
                </div>
                <div class="card-body">
                    <form class="mt-3">
                        <div class="row-mb">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" v-model="serviceCreateData.name" id="name" class="form-control" required placeholder="Enter Name">
...
import { fetchUserRole } from "@/services/userService";
  ...
  export default {
    ...
    methods: {
        ServicesSave(){
          this.getLoader = true;
          axios.post(this.globalVariables.apiUrl+"admin/faq/services/store", this.serviceCreateData, {
            headers: {
