                            ...
                            <div class="row px-3" id="externalFiltersWrapper">
                              <div class="col-md-6 border-right">
                                <ul class="px-0 mt-3" id="offer-extra-filter">
                                  <li class="position-relative">
                                    <a :class="checkfilter.showcolumn == 'To' ? 'check-active' : ''"
                                      @click="clickFilters('user', 'search', 'To')">To
                                    </a>
                                    <template v-if="applyfillters.includes('To')">
                                      <span @click="removeSearch('To', 'user', 'search')" id="remove-to-search-list">x</span>
                                    </template>
                                  </li>
                                  <li class="position-relative">
                              ...
                              <div class="col-md-6 ps-4">
                                <div v-if="checkfilter.showcolumn != null && checkfilter.showcolumn != ''">
                                  ...
                                  <template v-if="checkfilter.showcolumn == 'To' && checkfilter.types.includes('search')">
                                    <div class="form-check mb-2">
                                      <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                                        v-model="checkfilter.emptyValues['user']" type="checkbox" value="1" id="isemptyvalue">
                                    ...
                                    <div class="form-check mb-2">
                                      <input class="form-check-input" @change="clickCheckboxFilters(checkfilter.showcolumn)"
                                        v-model="checkfilter.notemptyValues['user']" type="checkbox" value="0"
                                        id="isnotemptyvalue">
                                    ...
                                    <div>
                                      <template v-if="checkfilter.showcolumn == 'To' && checkfilter.types.includes('search')">
                                        ...
                                        <input type="text" @keyup="clickCheckboxFilters(checkfilter.showcolumn)"
                                          v-model="checkfilter.searchValues['user']" class="form-control mb-2" id="filtertext"
...
export default {
  ...
  methods: {
            ...
            var table = $('#emails_tables').DataTable({
              ...
              columns: [
                ...
                //  { data: 'body' },
                {
                 data : "updated_at",
                 render: function (data, type, row) {
                  return '<div class="text-center"><button data-id="'+row.id+'" title="View"  data-bs-toggle="modal" data-bs-target="#emailLogsContent" id="content-view" class="industial_contact_view text-info border-0"><i id="content-view" class="fas fa-eye fa-sm" data-id="'+row.id+'"></i></button></div>'
                 }
              }
    ...
    attachEventListenersOfButton(){
      $("#emails_tables_wrapper").on("click", "button", (event) => {
    ...
    getFiltarOfExtranalFilter(perPage = 10,) {
          axios
            .post(
              this.globalVariables.apiUrl + "admin/emails-search-get-data-all-filter",
              this.checkfilter,
              {
                headers: { Authorization: "Bearer " + localStorage.getItem("token") }
              }
